...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <div class=\"ion-padding\">\n    <h1>Funcionando.</h1>\n\n    <input type=\"button\" (click)=\"conectar()\" value=\"Conectar\">\n\n    <p id=\"data\"></p>\n\n  </div>\n\n</ion-content>"
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.conectar = function () {
        ...
        new WebSocket('ws://localhost:8080')
            .addEventListener("message", function (payload) {
            var buffer = JSON.parse(payload.data).buf;
            var song = _this.ctx.createBuffer(buffer.numberOfChannels, buffer.length, buffer.sampleRate);
